...
for (let i of mapsStr) {
  ...
  kotizu01aomoriObj[i] .addFilter(crop);
  var mask = new Mask({
    feature: f,
    wrapX: true,
    inner: false,
  ...
  kotizu01aomoriObj[i] .addFilter(mask);
  mask.set('active', false);
 }
  ...
  [
    ...
    { text: '古地図',
      children: [
        ...
        { text: '青森県古地図', data: { id: 'kotizu01aomori', layer: kotizu01aomoriObj, opacity: 1, zoom: 8, center: [142.6944008210318, 43.241646716680606], summary: kotizu01aomoriSumm } }
      ]},
    // { text: '今昔マップ',
    //   children: [
    //     { text: '福岡・北九州編',
